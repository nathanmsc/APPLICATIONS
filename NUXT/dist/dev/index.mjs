...
import { getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, getRequestURL, getResponseHeader, defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, getResponseStatus, setHeaders, sendRedirect, proxyRequest, createError, getRequestHost, getRequestProtocol, getQuery as getQuery$1, setHeader, getHeader, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, readBody, getResponseStatusText } from 'file:///home/mindsetcloud/src/APPLICATIONS/NUXT/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve as resolve$1, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///home/mindsetcloud/src/APPLICATIONS/NUXT/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import destr from 'file:///home/mindsetcloud/src/APPLICATIONS/NUXT/node_modules/destr/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL, hasProtocol, withHttps, withoutProtocol, withLeadingSlash, withoutTrailingSlash, withBase, parsePath, parseQuery, stringifyQuery, encodePath, stringifyParsedURL } from 'file:///home/mindsetcloud/src/APPLICATIONS/NUXT/node_modules/ufo/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///home/mindsetcloud/src/APPLICATIONS/NUXT/node_modules/unhead/dist/server.mjs';
import { isVNode, toValue, isRef } from 'file:///home/mindsetcloud/src/APPLICATIONS/NUXT/node_modules/vue/index.mjs';
import { walkResolver } from 'file:///home/mindsetcloud/src/APPLICATIONS/NUXT/node_modules/unhead/dist/utils.mjs';
import { renderToString } from 'file:///home/mindsetcloud/src/APPLICATIONS/NUXT/node_modules/vue/server-renderer/index.mjs';
import { createHooks } from 'file:///home/mindsetcloud/src/APPLICATIONS/NUXT/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///home/mindsetcloud/src/APPLICATIONS/NUXT/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///home/mindsetcloud/src/APPLICATIONS/NUXT/node_modules/node-mock-http/dist/index.mjs';
import { klona } from 'file:///home/mindsetcloud/src/APPLICATIONS/NUXT/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file:///home/mindsetcloud/src/APPLICATIONS/NUXT/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///home/mindsetcloud/src/APPLICATIONS/NUXT/node_modules/scule/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/mindsetcloud/src/APPLICATIONS/NUXT/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/mindsetcloud/src/APPLICATIONS/NUXT/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/mindsetcloud/src/APPLICATIONS/NUXT/node_modules/radix3/dist/index.mjs';
import { getContext } from 'file:///home/mindsetcloud/src/APPLICATIONS/NUXT/node_modules/unctx/dist/index.mjs';
import { digest } from 'file:///home/mindsetcloud/src/APPLICATIONS/NUXT/node_modules/ohash/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1, createConsola } from 'file:///home/mindsetcloud/src/APPLICATIONS/NUXT/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///home/mindsetcloud/src/APPLICATIONS/NUXT/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///home/mindsetcloud/src/APPLICATIONS/NUXT/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///home/mindsetcloud/src/APPLICATIONS/NUXT/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///home/mindsetcloud/src/APPLICATIONS/NUXT/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/mindsetcloud/src/APPLICATIONS/NUXT/node_modules/errx/dist/index.js';
import devalue from 'file:///home/mindsetcloud/src/APPLICATIONS/NUXT/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { basename } from 'file:///home/mindsetcloud/src/APPLICATIONS/NUXT/node_modules/@nuxt/icon/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///home/mindsetcloud/src/APPLICATIONS/NUXT/node_modules/@iconify/utils/lib/index.mjs';
import { hash as hash$1 } from 'file:///home/mindsetcloud/src/APPLICATIONS/NUXT/node_modules/@nuxt/icon/node_modules/ohash/dist/index.mjs';
import { collections } from 'file:///home/mindsetcloud/src/APPLICATIONS/NUXT/dist/nuxt-icon-server-bundle.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///home/mindsetcloud/src/APPLICATIONS/NUXT/node_modules/ipx/dist/index.mjs';
import { isAbsolute } from 'file:///home/mindsetcloud/src/APPLICATIONS/NUXT/node_modules/pathe/dist/index.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///home/mindsetcloud/src/APPLICATIONS/NUXT/node_modules/unhead/dist/plugins.mjs';
...
const _UhU4zZTCyk5y4y5js2KhmtTzDX3_IZBfDiauiPlZrDU = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/home/mindsetcloud/src/APPLICATIONS/NUXT";
...
const _yYqpCavNu_93L6TN1gHlhDD84lSK9in7nPsmRLHD4 = (nitroApp) => {
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/home/mindsetcloud/src/APPLICATIONS/NUXT/public"
      ]
    },
    "http": {
      "domains": []
...
const serverAssets = [{"baseName":"server","dir":"/home/mindsetcloud/src/APPLICATIONS/NUXT/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/mindsetcloud/src/APPLICATIONS/NUXT","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/mindsetcloud/src/APPLICATIONS/NUXT/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/mindsetcloud/src/APPLICATIONS/NUXT/dist"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/mindsetcloud/src/APPLICATIONS/NUXT/dist/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/mindsetcloud/src/APPLICATIONS/NUXT/.data/kv"}));
...
const plugins = [
  _UhU4zZTCyk5y4y5js2KhmtTzDX3_IZBfDiauiPlZrDU,
_yYqpCavNu_93L6TN1gHlhDD84lSK9in7nPsmRLHD4,
...
const _sALlWC = defineEventHandler(async (e) => {
  const siteConfig = useSiteConfig(e);
  const nitroOrigin = useNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _6MiG_p = defineEventHandler(async (e) => {
...
const _pw_G8e = defineEventHandler(async (e) => {
...
const __eppfS = defineEventHandler(async (e) => {
...
const _lazy_u5LJdP = () => Promise.resolve().then(function () { return renderer$1; });
...
const handlers = [
  ...
  { route: '/__site-config__/debug.json', handler: _sALlWC, lazy: false, middleware: false, method: undefined },
  ...
  { route: '/__robots__/debug.json', handler: _6MiG_p, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug-path.json', handler: _pw_G8e, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: __eppfS, lazy: false, middleware: false, method: undefined },
  ...
  { route: '/_fonts/**', handler: _lazy_u5LJdP, lazy: true, middleware: false, method: undefined },
...
const getClientManifest = () => import('file:///home/mindsetcloud/src/APPLICATIONS/NUXT/dist/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///home/mindsetcloud/src/APPLICATIONS/NUXT/dist/dist/server/server.mjs').then((r) => r.default || r);
